...
final class ProUpsell
{
    ...
    private function priceLabel(): string
    {
        ...
        if (! empty($d['price_from'])) {
            ...
            return sprintf(__('from %1$s%2$d/yr', 'tabvera'), $cur, (int) $d['price_from']);
        }
        return '';
    }
    ...
    public function handleDismiss(): void
    {
        if (! current_user_can('manage_woocommerce')) {
            wp_die(esc_html__('Permission denied.', 'tabvera'));
        }
    ...
    public function banner(): void
    {
        ...
        $name     = (string) ($this->data()['name'] ?? 'Tabvera Pro');
        ...
        <div class="tabby-pro-banner" role="note">
            ...
            <p class="tabby-pro-banner__text">
                ...
                printf(esc_html__('Do more with %s', 'tabvera'), esc_html($name)); ?></strong>
            ...
            <a class="tabby-pro-banner__dismiss" href="<?php echo esc_url($this->dismissUrl()); ?>" aria-label="<?php esc_attr_e('Dismiss this notice', 'tabvera'); ?>">&times;</a>
        </div>
        <?php
    }
    ...
    public function aside(): void
    {
        ...
        <aside class="tabby-card tabby-pro-aside" aria-labelledby="tabby-pro-aside-h">
            ...
            <h2 id="tabby-pro-aside-h" class="tabby-pro-aside__heading"><?php esc_html_e('Unlock every PRO feature', 'tabvera'); ?></h2>
            ...
            <?php if ($price !== '') : ?>
                <p class="tabby-pro-aside__price"><?php echo esc_html($price); ?><?php if ($this->sellable()) : ?> · <?php esc_html_e('one licence, every PRO feature', 'tabvera'); ?><?php endif; ?></p>
            <?php endif; ?>
        </aside>
        <?php
    }
    ...
    public function cards(): void
    {
        ...
        <section class="tabby-pro-cards" aria-labelledby="tabby-pro-cards-h">
            <h2 id="tabby-pro-cards-h" class="tabby-pro-cards__title">
                <?php
                /* translators: %s: PRO edition name */
                printf(esc_html__('What %s adds', 'tabvera'), esc_html($name)); ?>
            </h2>
